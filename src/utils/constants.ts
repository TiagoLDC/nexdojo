// Constantes de faixa/graduação (BELT_COLORS, MIN_AGE_FOR_BELT, BELT_ORDER, etc.) foram
// removidas daqui em 11/08/2026 por serem cópias mortas — zero consumidores fora deste
// arquivo e do já removido src/utils/graduation.ts. Fonte única hoje: constants.ts (raiz)
// e services/graduation.ts. Ver PLANO_GRADUACAO.md Fase 4.
